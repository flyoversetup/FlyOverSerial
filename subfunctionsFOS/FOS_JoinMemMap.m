function mmap = FOS_JoinMemMap(strFile,strFormat,boolPersistent)
	...
	if ~exist(strFilename,'file')
		error([mfilename ':FileMissing'],sprintf('Specified container file does not exist: %s',strFile)); %#ok<SPERR> 
	else
		%start memory map
